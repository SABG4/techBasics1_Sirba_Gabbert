# Birthday Planning Game - Refactored Version
...
def custom_invitation(guest_name, birthday, user_name):
    return f"Dear {guest_name}, I would like to invite you to my birthday party on {birthday}. The exact time and location will be announced later. I would be thrilled if you could come:)). Yours, {user_name}🌸"
...
def main():
    ...
    if birthday.replace("-", "").isdigit() and birthday == TODAY_STR:
        print(f"Happppy Birthday {user_name} \n I hope you are having a wonderful day 🥳🎂🎈")
    else:
    ...
    if invitation.lower() == "yes":
        ...
        print(custom_invitation(guest_name, birthday, user_name))
    else:
